    ...
    return {
      ...
      description:
        context === "feature"
          ...
          : "Мы проверяем данные заведения. После одобрения откроются позиции, заказы, выдача и аналитика.",
    };
  }
  if (status === "REJECTED") {
    return {
      ...
      description: note ? `Причина: ${note}` : "Заявка не прошла проверку. Уточните данные заведения и отправьте их снова.",
    };
  }
  if (status === "SUSPENDED") {
    return {
