...
START_MESSAGE = (
    "Привет! Это Polka 🍽️\n\n"
    "Находим позиции еды рядом, которые можно забронировать и забрать в заведении по коду или QR.\n\n"
    "Внутри можно выбрать роль: покупатель или бизнес. Нажмите кнопку ниже, чтобы открыть приложение 🌿"
)
