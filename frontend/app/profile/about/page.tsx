...
const sections = [
  {
    ...
    body: "Polka помогает покупать позиции еды, которые заведения готовы отдать в конце дня или перед обновлением витрины. Доступны бронирование, код/QR для выдачи и история заказов.",
  },
  {
    title: "Как работает заказ",
    body: "Вы выбираете оффер, бронируете позицию и показываете код заведению в указанное время. Состав может меняться: заведение собирает её из того, что доступно на витрине.",
  },
  {
