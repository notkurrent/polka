...
const sections = [
  {
    ...
    body: "Polka помогает находить товары локальных магазинов и быстро переходить к прямому контакту с продавцом.",
  },
  {
    title: "Как работает контакт",
    body: "Вы выбираете товар и уточняете наличие, оплату и получение напрямую с магазином. Продавец подтверждает актуальные условия.",
  },
  {
