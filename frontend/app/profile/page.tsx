  ...
  return (
    <div className="screen-scroll-with-tabbar" style={{ background: t.bg }}>
      ...
      >
          ...
          {menuItems.map((item, i) => (
            <button
              ...
              style={{
                ...
                background: t.bg,
                border: "none",
                borderBottom: i < menuItems.length - 1 ? `1px solid ${t.divider}` : "none",
                fontSize: 14,
                cursor: "pointer",
                textAlign: "left",
              }}
            >
              ...
              <span style={{ color: t.textTer, display: "flex" }}>{Icon.chevronR(14, t.textTer)}</span>
            </button>
          ))}
        </div>
        ...
        >
          <PillButton onClick={openBusinessCabinet} variant="outline" size="md">
            Бизнес-кабинет
          </PillButton>
